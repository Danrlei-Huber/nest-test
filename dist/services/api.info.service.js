...
exports.apiInfoService = void 0;
const common_1 = require("@nestjs/common");
const data_source_1 = require("../config/data-source");
const user_1 = require("../domain/entitys/user/user");
const requestDTO_1 = require("../domain/requestDTO");
const typeorm_1 = require("typeorm");
let apiInfoService = class apiInfoService {
    constructor() {
        this.userRepository = data_source_1.AppDataSource.getRepository(user_1.User);
    }
    ola() {
        const response = new requestDTO_1.ResponseDTO(true, 'api online', typeorm_1.Any);
        return response;
    }
...
exports.apiInfoService = apiInfoService = __decorate([
    (0, common_1.Injectable)()
], apiInfoService);
//# sourceMappingURL=api.info.service.js.map